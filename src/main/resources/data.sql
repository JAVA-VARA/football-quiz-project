...
('아틀레티코 마드리드', 'http://dummyimage.com/238x100.png/ff4444/ffffff','Laliga'),
('레알 마드리드', 'http://dummyimage.com/238x100.png/ff4444/ffffff' ,'Laliga'),
('바르셀로나', 'http://dummyimage.com/238x100.png/ff4444/ffffff' ,'Laliga'),
('레알 소시에다드', 'http://dummyimage.com/238x100.png/ff4444/ffffff' ,'Laliga'),
('그라나다', 'http://dummyimage.com/238x100.png/ff4444/ffffff' ,'Laliga'),
('첼시', 'http://dummyimage.com/238x100.png/ff4444/ffffff','프리미어리그'),
('나폴리', 'http://dummyimage.com/238x100.png/ff4444/ffffff', '세리에'),
('도르트문트', 'http://dummyimage.com/238x100.png/ff4444/ffffff', '분데스리가');
...
(1, '축구 선수 사진 보고 이름 맞추기', '축구 선수 사진을 보고 이름을 맞춰봐' , 'http://dummyimage.com/238x100.png/ff4444/ffffff', '/who-are-you');
